/*axios.get('http://wednesdays.ddns.net:9001/calculate_iss_position')
    .then(response => {
...
class ISS {
    ...
    set_azimuth(data) {
        this.azimuth = data.iss_position.azimuth;
    }
    ...
    set_user_longitude(data) {
        this.user_longitude = data.user_location.longitude;
    }
...
async function getISSData() {
    try {
        ...
        return [iss.azimuth, iss.elevation, iss.latitude, iss.longitude, iss.user_latitude, iss.user_longitude];
    } 
